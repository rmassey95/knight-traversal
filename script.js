...
// bst.knightMoves([3, 3], [4, 3]);

// const NodeFactory = (move, children) => {
//   this.move = move;
//   this.children = children;
// };

// const Tree = (startPos, endPos) => {
//   const possibleMoves = [
//     [-2, -1],
//     [-1, -2],
//     [-2, 1],
...
//   const buildTree = (startPos, endPos) => {
//     let moves = [];

//     for (let i = 0; i < possibleMoves.length; i++) {
//       let arr = [];
//       arr.push(startPos[0] + possibleMoves[i][0]);
//       arr.push(startPos[1] + possibleMoves[i][1]);

//       if ((arr[0] >= 0 && arr[0] <= 7) || (arr[1] >= 0 && arr[1] <= 7)) {
//         moves.push(arr);
//       }
//       if (arr[0] === endPos[0] && arr[1] === endPos[1]) {
//         console.log("MATCH");
//         break;
//       }
//     }

//     let node = NodeFactory(startPos, moves);
//     return node;
//   };

//   let root = buildTree(startPos, endPos);
